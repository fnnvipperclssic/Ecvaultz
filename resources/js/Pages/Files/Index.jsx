    ...
    const onDrop = useCallback((acceptedFiles) => {
        ...
        router.post('/files', formData, {
            ...
            onError: (errors) => {
                setUploading(false);
                setUploadProgress({});
                alert('Upload failed: ' + (typeof errors === 'string' ? errors : 'File type or size not allowed.'));
            },
            preserveScroll: true,
        });
    }, [currentFolderId]);
                                    ...
                                    <tr key={file.uuid} className="hover:bg-surface-50 transition-colors group">
                                        ...
                                        <td className="py-3 pr-4">
                                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                ...
                                                <Link href={'/shares?file_uuid=' + file.uuid} className="rounded p-1 text-surface-400 hover:text-amber-500 hover:bg-amber-500/10" title="Share">
